package com.brantyu.byrecyclerview.decoration;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration setDrawLastItem(boolean mDrawLastItem) {
        this.mDrawLastItem = mDrawLastItem;
        return this;
    }

    public DividerDecoration setDrawHeaderFooter(boolean mDrawHeaderFooter) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof BaseDelegateAdapter) {
            headerCount = ((BaseDelegateAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((BaseDelegateAdapter) parent.getAdapter()).getFooterCount();
        }
        ...
        if (position >= headerCount && position < parent.getAdapter().getItemCount() - footerCount - 1 || mDrawHeaderFooter) {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getAdapter() instanceof BaseDelegateAdapter) {
            headerCount = ((BaseDelegateAdapter) parent.getAdapter()).getHeaderCount();
            footerCount = ((BaseDelegateAdapter) parent.getAdapter()).getFooterCount();
            dataCount = ((BaseDelegateAdapter) parent.getAdapter()).getCount();
        } else {
